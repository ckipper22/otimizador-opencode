...
import { TrendingDown, PackageCheck, DollarSign, ArrowUpRight, Percent } from "lucide-react";
...
export default function OptimizationSummaryStats({
  ...
  return (
    <div id="optimization-summary-stats" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      {/* Cost original */}
